            ...
            <div class="row gy-5 gx-4">
                @foreach ($services as $service)
                    <div class="col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <img class="img-fluid mb-3" src="{{ asset($service->image) }}" alt="Icon">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                @forelse ($avis as $avi)
                    <div class="testimonial-item text-center">
                        <img class="img-fluid rounded-circle border border-2 p-2 mx-auto mb-4" src="{{ asset($avi->fichier ?? 'assets/guest/img/icon/icon-10.png') }}" style="width: 100px; height: 100px;">
                        <div class="testimonial-text rounded text-center p-4">
                            <p>« {{ $avi->description }} »</p>
                            <h5 class="mb-1"> {{ $avi->nom }} </h5>
                        </div>
                    </div>
                @empty
            ...
            <form action="{{ route('avis.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Laisser mon avis</button>
                    </div>
                </div>
            </form>
        </div>
