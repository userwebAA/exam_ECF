...
Route::middleware('auth')->group(function () {
    ...
    Route::post('habitats_comment', [HabitatController::class, 'comment'])->name('habitats.comment');
    ...
    Route::post('animals/comment', [AnimalController::class, 'comment'])->name('animals.comment');
    ...
    Route::get('avis', [AviController::class, 'index'])->name('avis.index');
    Route::post('avis/store', [AviController::class, 'store'])->name('avis.store');
    Route::get('avis/store/{avi}/{status}', [AviController::class, 'update_status'])->name('avis.update_status');
});
